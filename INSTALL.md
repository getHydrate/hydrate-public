...
| `<project>/HYDRATE-wiki/` | autonomous project wiki (v0.6.0+; regenerated by `hydrate wiki curate`) |
| `~/.hydrate/auto-wiki/<slug>.last` | 6-hour cadence marker for the wiki worker |
| `~/.hydrate/auto-wiki/<slug>.lock` | single-instance lock (worker exit clears) |
